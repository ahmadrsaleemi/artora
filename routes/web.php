...
Route::get('/events/add', [EventController::class, 'addEvent'])->middleware('auth');
Route::get('/events/view', [EventController::class, 'viewEvent'])->middleware('auth');
Route::post('/events/AddSeatsToTable', [EventController::class, 'addSeatsToTable'])->middleware('auth');
Route::post('registerEvent',[EventController::class, 'registerEvent'])->name('register_event')->middleware('auth');
Route::get('/events/updateConceptPage/{id}',[EventController::class, 'updateEventPage'])->middleware('auth');
